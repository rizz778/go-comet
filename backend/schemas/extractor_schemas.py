...
class ExtractedField(BaseModel):
    value: Optional[str] = Field(default=None, description="The extracted value of the field. Return null if not found.")
    ...
    source_snippet: Optional[str] = Field(default=None, description="The exact snippet of text from the document where this field was found.")
...
class TradeDocumentExtraction(BaseModel):
    ...
    extraction_warnings: List[str] = Field(default_factory=list, description="Document-level warnings.")
